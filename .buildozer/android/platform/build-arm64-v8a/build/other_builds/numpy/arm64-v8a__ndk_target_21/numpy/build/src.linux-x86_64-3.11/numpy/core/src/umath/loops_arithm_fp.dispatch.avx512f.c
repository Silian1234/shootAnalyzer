...
#include "/root/shootAnalyzer/.buildozer/android/platform/build-arm64-v8a/build/other_builds/numpy/arm64-v8a__ndk_target_21/numpy/build/src.linux-x86_64-3.11/numpy/core/src/umath/loops_arithm_fp.dispatch.c"
