...
SRC_IMG_DIR   = 'data/images/all'     # все ваши .jpg/.png
SRC_LABEL_DIR = 'data/labels/all'     # .txt с аннотациями (пустые для отрицательных примеров)

# Пути для итоговых train/val
...
# Параметры
TRAIN_RATIO = 0.8   # 80% в train, 20% в val
SEED        = 42
...
def split_and_copy():
    ...
    # Балансируем: оставляем ровно столько же отрицательных, сколько положительных
    ...
    for img_set, img_dir, lbl_dir in (
        ...
        for fname in img_set:
            ...
            # если .txt нет или он пустой — создаём пустой
